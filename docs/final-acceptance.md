...
| Architecture and operations can be explained | Pass | [Project defense guide](project-defense.md) |
| Public claims map to evidence | Pass | [Evidence index](evidence/README.md) |
| Limitations are explicit | Pass | [Architecture](architecture.md) and [career evidence](career-stories.md) |
...
| Local documentation links | Pass | 28 Markdown files checked with no missing local target |
