...
> **Current status:** Workstation and repository bootstrap are in progress. The application, deployment environments, and public URL do not exist yet.
...
Finish the reviewed repository bootstrap for Milestone 1 before adding application code or infrastructure.
